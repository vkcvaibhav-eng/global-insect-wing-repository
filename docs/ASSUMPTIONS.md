...
9. The sample wing image is a synthetic demonstration drawing, explicitly not
   a taxonomic reference specimen.
10. SQLite supports a local, low-concurrency demonstration only. PostgreSQL is
